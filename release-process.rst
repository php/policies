...
-  Adding TypeError and ValueError exceptions to validate inputs to functions and
   methods. These are not classified as BC breaks because not adding them allows
   incorrect code to run and thus leads to hard to debug code.
